...
We have a folder called class_photos containing class-named
subfolders of 'classroom/lab','corridor', etc., each containing full of images for respective categories. 
